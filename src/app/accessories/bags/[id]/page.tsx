...
const BagsId = () => {
  ...
  const { id } = router.query; // Dynamic parameter
    ...
    <div className="max-w-screen-2xl mx-auto">
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between m-10 mt-16">
        ...
        <div className="flex flex-col lg:w-1/4">
          ...
          <h2 className="mt-4 text-lg font-medium text-gray-700">Size</h2>
          <p className="m-2 text-gray-600">{selectedProduct.color}</p>
          <p className="m-2 text-gray-600">{selectedProduct.weight}</p>
          <p className="m-2 text-gray-600">{selectedProduct.code}</p>
        </div>
      </div>
    </div>
  );
