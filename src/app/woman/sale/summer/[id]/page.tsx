...
function WomanSummerSale({ params }: WomanSaleSummerIdProps) {
    ...
    // // Keep the useState and useEffect hooks at the top level
    // const selectedProduct = products.find((item) => item.id === Number(params.id));
    ...
    //     const stars = []; // Changed let to const
    //     for (let i = 0; i < 5; i++) {
    //         if (i < rating) {
...
export default WomanSummerSale;
